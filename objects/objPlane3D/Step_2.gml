...
if gamepad_is_connected(0) {
	...
	var kZup = gamepad_button_check_pressed(0, gp_face3);
    var kZdown = gamepad_button_check_pressed(0, gp_face4);
	...
	var kZup = keyboard_check(ord("Z"));
    var kZdown = keyboard_check(ord("X"));

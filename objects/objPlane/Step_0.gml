...
if instance_exists(o_moon) {
    ...
    distance_to_moon = point_distance(x, y, o_moon.x, o_moon.y);
    // Set the maximum gravity you want
    // Calculate the gravity based on distance
    gravity = max_gravity_moon - (max_gravity_moon / max_distance_to_moon) * distance_to_moon;
    // Set the direction of gravity
    gravity_direction = point_direction( o_moon.x, o_moon.y,x, y);
}
